...
export EDPOSE_COCO_PATH=/net/cluster/azhar/datasets/SensoryGestureRecognition/data/sensoryArt_coco
...
do
    ...
    command="python main.py  --config_file config/edpose.cfg.py --pretrain_model_path ./models/edpose_r50_coco.pth --finetune_ignore class_embed. \
        --output_dir logs/multiruns_sensorytest_gestures/edpose_finetune$i/all_coco/ \
