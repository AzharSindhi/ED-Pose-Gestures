...
#SBATCH --job-name=ed_actionpose_sanity
#SBATCH --gres=gpu:a100:1
#SBATCH --array=0 # Adjust based on the number of experiments
...
TARGET_WORKDIR="$WORK/work_dirs/ed_actionpose/sanity/${SLURM_JOB_ID}_${SLURM_ARRAY_TASK_ID}"
