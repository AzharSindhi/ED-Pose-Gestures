...
readonly TARGET_PATH=${TMPDIR}/${SLURM_JOB_ID}_${FOLD_NR}
...
readonly SOURCE_DATA=/home/atuin/$GROUP/$USER/data/sensoryart/crossval/fold${FOLD_NR}.tar
...
# TARGET_WORKDIR="$WORK/work_dirs/ed_actionpose/full_classifier_noseptoken/${$FOLD_NR}"
