...
#SBATCH --output=/home/woody/iwi5/iwi5197h/ED-Pose-Simplified/slurm_logs/%x_%j_out.txt
#SBATCH --error=/home/woody/iwi5/iwi5197h/ED-Pose-Simplified/slurm_logs/%x_%j_err.txt
...
MODELPATH=$WORK_DIR/ED-Pose-Gestures/models/edpose_swinl_coco.pth
...
do
    ...
    run_name="lr${LR}_wd${WEIGHT_DECAY}_lrd${LR_DROP}_ng${NUM_GROUP}_dn${DN_NUMBER}_swinl"
    ...
    command="python main.py  --config_file config/edpose.cfg.py --pretrain_model_path $MODELPATH --finetune_ignore class_embed. \
        --output_dir logs/swinl_exps_bs2/edpose_orig$i/all_coco/ \
