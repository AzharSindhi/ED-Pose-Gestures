...
"python  main.py  --seperate_classifier --classifier_type full --config_file config/classifier.cfg.py --edpose_model_path logs/train_sniffy/gestures_allclasses_coco_pretrained_r50/checkpoint.pth \
