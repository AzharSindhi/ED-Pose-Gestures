...
commands=(
    ...
    "python main.py  --seperate_token_for_class --config_file config/edpose.cfg.py --pretrain_model_path logs/train_sniffy/gestures_persononly_coco_pretrained_r50/checkpoint.pth --finetune_ignore class_embed. \
