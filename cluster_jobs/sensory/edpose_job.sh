...
commands=(
    ...
    # "python main.py  --config_file config/edpose.cfg.py --pretrain_model_path logs/train_sensory/gestures_persononly_coco_pretrained_r50/checkpoint.pth --finetune_ignore class_embed. \
    ...
    # "python main.py  --dec_layers 8 --config_file config/edpose.cfg.py --pretrain_model_path logs/train_sensory/gestures_allclasses_coco_pretrained_r50/checkpoint.pth --finetune_ignore class_embed. \
    # --output_dir logs/train_sensory/edpose_nd8/finetuned/all_edpose/ --options batch_size=4 epochs=20 lr_drop=6 num_body_points=17 backbone=resnet50 \
    # --dataset_file=coco"
