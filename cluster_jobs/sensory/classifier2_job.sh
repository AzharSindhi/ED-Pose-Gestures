...
"python  main.py  --seperate_classifier --classifier_type full --config_file config/classifier.cfg.py --edpose_model_path logs/train/gestures_allclasses_coco_pretrained_r50/checkpoint.pth \
    --output_dir logs/train/classifier2/deformable_nofinetune/all_edpose/ --options batch_size=4 epochs=20 lr_drop=6 num_body_points=17 backbone=resnet50 \
    --classifier_use_deformable \
    --dataset_file=coco \
    --classifier_decoder_layers=2 --find_unused_params"

"python  main.py  --seperate_classifier --classifier_type full --config_file config/classifier.cfg.py --edpose_model_path logs/train/gestures_allclasses_coco_pretrained_r50/checkpoint.pth \
    --output_dir logs/train/classifier2/deformable_finetune/all_edpose/ --options batch_size=4 epochs=20 lr_drop=6 num_body_points=17 backbone=resnet50 \
    --finetune_edpose \
    --classifier_use_deformable \
    --dataset_file=coco \
    --classifier_decoder_layers=2 --find_unused_params" 
...
"python  main.py  --seperate_classifier --classifier_type full --config_file config/classifier.cfg.py --edpose_model_path logs/train/gestures_allclasses_coco_pretrained_r50/checkpoint.pth \
    --output_dir logs/train/classifier2/vanilla_nofinetune/all_edpose/ --options batch_size=4 epochs=20 lr_drop=6 num_body_points=17 backbone=resnet50 \
    --dataset_file=coco \
    --classifier_decoder_layers=2 --find_unused_params"

"python  main.py  --seperate_classifier --classifier_type full --config_file config/classifier.cfg.py --edpose_model_path logs/train/gestures_allclasses_coco_pretrained_r50/checkpoint.pth \
    --output_dir logs/train/classifier2/vanilla_finetune/all_edpose/ --options batch_size=4 epochs=20 lr_drop=6 num_body_points=17 backbone=resnet50 \
    --finetune_edpose \
    --dataset_file=coco \
    --classifier_decoder_layers=2 --find_unused_params"
)
