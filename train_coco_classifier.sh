...
python main.py  --seperate_classifier --config_file "config/classifier.cfg.py" --edpose_model_path "logs/train/gestures_allclasses_coco_pretrained_r50/checkpoint.pth" \
    --output_dir "logs/train/gestures_classifier1/finetune2_vanilla/all_classes_pretrained_r50_coco/" --options batch_size=1 epochs=20 lr_drop=6 num_body_points=17 backbone='resnet50' \
    --dataset_file="coco" \
